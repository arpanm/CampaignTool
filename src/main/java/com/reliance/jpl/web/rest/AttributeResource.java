...
/**
 * REST controller for managing {@link com.reliance.jpl.domain.Attribute}.
 */
@RestController
@RequestMapping("/api")
public class AttributeResource {
    ...
    public ResponseEntity<List<AttributeDTO>> getAllAttributes(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
