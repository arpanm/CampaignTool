...
/**
 * REST controller for managing {@link com.reliance.jpl.domain.LeadUploadFile}.
 */
@RestController
@RequestMapping("/api")
public class LeadUploadFileResource {
    ...
    public ResponseEntity<LeadUploadFileDTO> updateLeadUploadFile(
        ...
        LeadUploadFileDTO result = leadUploadFileService.update(leadUploadFileDTO);
        return ResponseEntity
            .ok()
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/lead-upload-files/{id}", consumes = { "application/json", "application/merge-patch+json" })
    ...
    public ResponseEntity<List<LeadUploadFileDTO>> getAllLeadUploadFiles(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
