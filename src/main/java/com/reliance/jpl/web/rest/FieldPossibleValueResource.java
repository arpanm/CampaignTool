...
/**
 * REST controller for managing {@link com.reliance.jpl.domain.FieldPossibleValue}.
 */
@RestController
@RequestMapping("/api")
public class FieldPossibleValueResource {
    ...
    public ResponseEntity<FieldPossibleValueDTO> updateFieldPossibleValue(
        ...
        FieldPossibleValueDTO result = fieldPossibleValueService.update(fieldPossibleValueDTO);
        return ResponseEntity
            .ok()
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/field-possible-values/{id}", consumes = { "application/json", "application/merge-patch+json" })
    ...
    public ResponseEntity<List<FieldPossibleValueDTO>> getAllFieldPossibleValues(
