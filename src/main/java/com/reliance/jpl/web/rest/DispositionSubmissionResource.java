...
/**
 * REST controller for managing {@link com.reliance.jpl.domain.DispositionSubmission}.
 */
@RestController
@RequestMapping("/api")
public class DispositionSubmissionResource {
    ...
    public ResponseEntity<DispositionSubmissionDTO> updateDispositionSubmission(
        ...
        DispositionSubmissionDTO result = dispositionSubmissionService.update(dispositionSubmissionDTO);
        return ResponseEntity
            .ok()
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/disposition-submissions/{id}", consumes = { "application/json", "application/merge-patch+json" })
