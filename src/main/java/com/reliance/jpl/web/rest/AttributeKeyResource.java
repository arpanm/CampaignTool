...
/**
 * REST controller for managing {@link com.reliance.jpl.domain.AttributeKey}.
 */
@RestController
@RequestMapping("/api")
public class AttributeKeyResource {
    ...
    public ResponseEntity<AttributeKeyDTO> updateAttributeKey(
        ...
        AttributeKeyDTO result = attributeKeyService.update(attributeKeyDTO);
        return ResponseEntity
            .ok()
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/attribute-keys/{id}", consumes = { "application/json", "application/merge-patch+json" })
    ...
    public ResponseEntity<List<AttributeKeyDTO>> getAllAttributeKeys(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
