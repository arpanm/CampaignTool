...
/**
 * REST controller for managing {@link com.reliance.jpl.domain.LeadAssociation}.
 */
@RestController
@RequestMapping("/api")
public class LeadAssociationResource {
    ...
    public ResponseEntity<LeadAssociationDTO> updateLeadAssociation(
        ...
        LeadAssociationDTO result = leadAssociationService.update(leadAssociationDTO);
        return ResponseEntity
            .ok()
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/lead-associations/{id}", consumes = { "application/json", "application/merge-patch+json" })
    ...
    public ResponseEntity<List<LeadAssociationDTO>> getAllLeadAssociations(
