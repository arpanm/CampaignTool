...
/**
 * REST controller for managing {@link com.reliance.jpl.domain.Telecaller}.
 */
@RestController
@RequestMapping("/api")
public class TelecallerResource {
    ...
    public ResponseEntity<TelecallerDTO> updateTelecaller(
        ...
        TelecallerDTO result = telecallerService.update(telecallerDTO);
        return ResponseEntity
            .ok()
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/telecallers/{id}", consumes = { "application/json", "application/merge-patch+json" })
    ...
    public ResponseEntity<List<TelecallerDTO>> getAllTelecallers(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
