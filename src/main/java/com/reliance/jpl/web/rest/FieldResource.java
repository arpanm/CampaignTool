...
import com.reliance.jpl.repository.FieldRepository;
import com.reliance.jpl.service.FieldService;
...
/**
 * REST controller for managing {@link com.reliance.jpl.domain.Field}.
 */
@RestController
@RequestMapping("/api")
public class FieldResource {
     ...
     */
    @GetMapping("/fields")
    public ResponseEntity<List<FieldDTO>> getAllFields(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
