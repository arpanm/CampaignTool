...
import com.reliance.jpl.repository.LeadAssignmentRepository;
import com.reliance.jpl.service.LeadAssignmentService;
...
/**
 * REST controller for managing {@link com.reliance.jpl.domain.LeadAssignment}.
 */
@RestController
@RequestMapping("/api")
public class LeadAssignmentResource {
    ...
    public ResponseEntity<LeadAssignmentDTO> updateLeadAssignment(
        ...
        LeadAssignmentDTO result = leadAssignmentService.update(leadAssignmentDTO);
        return ResponseEntity
            .ok()
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/lead-assignments/{id}", consumes = { "application/json", "application/merge-patch+json" })
    ...
    public ResponseEntity<List<LeadAssignmentDTO>> getAllLeadAssignments(
