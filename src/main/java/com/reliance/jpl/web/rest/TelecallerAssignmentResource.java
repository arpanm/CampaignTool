...
/**
 * REST controller for managing {@link com.reliance.jpl.domain.TelecallerAssignment}.
 */
@RestController
@RequestMapping("/api")
public class TelecallerAssignmentResource {
    ...
    public ResponseEntity<TelecallerAssignmentDTO> updateTelecallerAssignment(
        ...
        TelecallerAssignmentDTO result = telecallerAssignmentService.update(telecallerAssignmentDTO);
        return ResponseEntity
            .ok()
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/telecaller-assignments/{id}", consumes = { "application/json", "application/merge-patch+json" })
    ...
    public ResponseEntity<List<TelecallerAssignmentDTO>> getAllTelecallerAssignments(
