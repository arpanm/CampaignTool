...
public class Location implements Serializable {
    ...
    public Location leads(Set<Lead> leads) {
        this.setLeads(leads);
        return this;
    }

    public Location addLead(Lead lead) {
        this.leads.add(lead);
        lead.getLocations().add(this);
        return this;
    }

    public Location removeLead(Lead lead) {
        this.leads.remove(lead);
        lead.getLocations().remove(this);
        return this;
    }

    public void setLeads(Set<Lead> leads) {
        if (this.leads != null) {
            this.leads.forEach(i -> i.removeLocation(this));
        }
        if (leads != null) {
            leads.forEach(i -> i.addLocation(this));
        }
        this.leads = leads;
    }
