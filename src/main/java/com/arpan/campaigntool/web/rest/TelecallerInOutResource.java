...
import com.arpan.campaigntool.repository.TelecallerInOutRepository;
import com.arpan.campaigntool.service.TelecallerInOutService;
...
/**
 * REST controller for managing {@link com.arpan.campaigntool.domain.TelecallerInOut}.
 */
@RestController
@RequestMapping("/api")
public class TelecallerInOutResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/telecaller-in-outs/{id}", consumes = "application/merge-patch+json")
    ...
    public ResponseEntity<List<TelecallerInOutDTO>> getAllTelecallerInOuts(Pageable pageable) {
