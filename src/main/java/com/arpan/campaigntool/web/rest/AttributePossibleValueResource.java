...
import com.arpan.campaigntool.service.AttributePossibleValueService;
...
/**
 * REST controller for managing {@link com.arpan.campaigntool.domain.AttributePossibleValue}.
 */
@RestController
@RequestMapping("/api")
public class AttributePossibleValueResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/attribute-possible-values/{id}", consumes = "application/merge-patch+json")
    ...
    public ResponseEntity<List<AttributePossibleValueDTO>> getAllAttributePossibleValues(Pageable pageable) {
