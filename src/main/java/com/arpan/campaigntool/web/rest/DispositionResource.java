...
import com.arpan.campaigntool.service.DispositionService;
...
/**
 * REST controller for managing {@link com.arpan.campaigntool.domain.Disposition}.
 */
@RestController
@RequestMapping("/api")
public class DispositionResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/dispositions/{id}", consumes = "application/merge-patch+json")
    ...
    public ResponseEntity<List<DispositionDTO>> getAllDispositions(Pageable pageable, @RequestParam(required = false) String filter) {
