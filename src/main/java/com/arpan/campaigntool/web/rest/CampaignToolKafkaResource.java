...
@RestController
@RequestMapping("/api/campaign-tool-kafka")
public class CampaignToolKafkaResource {

    private final Logger log = LoggerFactory.getLogger(CampaignToolKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public CampaignToolKafkaResource(KafkaProperties kafkaProperties) {
