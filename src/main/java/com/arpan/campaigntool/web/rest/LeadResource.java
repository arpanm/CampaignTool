...
import com.arpan.campaigntool.repository.LeadRepository;
import com.arpan.campaigntool.service.LeadService;
...
/**
 * REST controller for managing {@link com.arpan.campaigntool.domain.Lead}.
 */
@RestController
@RequestMapping("/api")
public class LeadResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/leads/{id}", consumes = "application/merge-patch+json")
