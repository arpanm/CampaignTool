...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './disposition-submission-value.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DISPOSITIONSUBMISSIONVALUE_LIST actions', async () => {
    ...
    it('dispatches FETCH_DISPOSITIONSUBMISSIONVALUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DISPOSITIONSUBMISSIONVALUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DISPOSITIONSUBMISSIONVALUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DISPOSITIONSUBMISSIONVALUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DISPOSITIONSUBMISSIONVALUE actions', async () => {
      const expectedActions = [
        {
