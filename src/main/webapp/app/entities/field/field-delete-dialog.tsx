...
export const FieldDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="automatedPerformanceTestingApp.field.delete.question">
        <Translate contentKey="automatedPerformanceTestingApp.field.delete.question" interpolate={{ id: fieldEntity.id }}>
