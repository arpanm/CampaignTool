...
export const AttributeKeyDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="automatedPerformanceTestingApp.attributeKey.delete.question">
        <Translate contentKey="automatedPerformanceTestingApp.attributeKey.delete.question" interpolate={{ id: attributeKeyEntity.id }}>
