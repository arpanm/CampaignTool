...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ATTRIBUTEKEY_LIST actions', async () => {
    ...
    it('dispatches FETCH_ATTRIBUTEKEY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ATTRIBUTEKEY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ATTRIBUTEKEY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ATTRIBUTEKEY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ATTRIBUTEKEY actions', async () => {
      const expectedActions = [
        {
