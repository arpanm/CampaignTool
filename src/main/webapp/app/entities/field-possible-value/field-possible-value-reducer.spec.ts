...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './field-possible-value.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FIELDPOSSIBLEVALUE_LIST actions', async () => {
    ...
    it('dispatches FETCH_FIELDPOSSIBLEVALUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FIELDPOSSIBLEVALUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FIELDPOSSIBLEVALUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FIELDPOSSIBLEVALUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FIELDPOSSIBLEVALUE actions', async () => {
      const expectedActions = [
        {
