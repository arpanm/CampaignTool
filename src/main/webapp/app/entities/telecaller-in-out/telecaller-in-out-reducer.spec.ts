...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './telecaller-in-out.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TELECALLERINOUT_LIST actions', async () => {
    ...
    it('dispatches FETCH_TELECALLERINOUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TELECALLERINOUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TELECALLERINOUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TELECALLERINOUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TELECALLERINOUT actions', async () => {
      const expectedActions = [
        {
