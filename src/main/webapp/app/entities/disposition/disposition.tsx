              ...
              <tbody>
                {dispositionList.map((disposition, i) => (
                  <tr key={`entity-${i}`} data-cy="entityTable">
                    ...
                    <td>{disposition.isActive ? 'true' : 'false'}</td>
                    <td>{disposition.createdBy}</td>
                    <td>
                      {disposition.createdAt ? (
                        <TextFormat type="date" value={disposition.createdAt} format={APP_LOCAL_DATE_FORMAT} />
                      ) : null}
                    </td>
                    <td>{disposition.updatedBy}</td>
                    <td>
