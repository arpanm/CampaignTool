...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './telecaller-assignment.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TELECALLERASSIGNMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_TELECALLERASSIGNMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TELECALLERASSIGNMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TELECALLERASSIGNMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TELECALLERASSIGNMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TELECALLERASSIGNMENT actions', async () => {
      const expectedActions = [
        {
