...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './attribute-possible-value.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ATTRIBUTEPOSSIBLEVALUE_LIST actions', async () => {
    ...
    it('dispatches FETCH_ATTRIBUTEPOSSIBLEVALUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ATTRIBUTEPOSSIBLEVALUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ATTRIBUTEPOSSIBLEVALUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ATTRIBUTEPOSSIBLEVALUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ATTRIBUTEPOSSIBLEVALUE actions', async () => {
      const expectedActions = [
        {
