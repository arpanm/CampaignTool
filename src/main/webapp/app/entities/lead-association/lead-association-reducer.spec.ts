...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEADASSOCIATION_LIST actions', async () => {
    ...
    it('dispatches FETCH_LEADASSOCIATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LEADASSOCIATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LEADASSOCIATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LEADASSOCIATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LEADASSOCIATION actions', async () => {
      const expectedActions = [
        {
