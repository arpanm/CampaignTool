...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TELECALLER_LIST actions', async () => {
    ...
    it('dispatches FETCH_TELECALLER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TELECALLER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TELECALLER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TELECALLER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TELECALLER actions', async () => {
      const expectedActions = [
        {
