...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './disposition-submission.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DISPOSITIONSUBMISSION_LIST actions', async () => {
    ...
    it('dispatches FETCH_DISPOSITIONSUBMISSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DISPOSITIONSUBMISSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DISPOSITIONSUBMISSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DISPOSITIONSUBMISSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DISPOSITIONSUBMISSION actions', async () => {
      const expectedActions = [
        {
