...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEADUPLOADFILE_LIST actions', async () => {
    ...
    it('dispatches FETCH_LEADUPLOADFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LEADUPLOADFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LEADUPLOADFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LEADUPLOADFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LEADUPLOADFILE actions', async () => {
      const expectedActions = [
        {
